...
class SchemaRegistryAnalyzer(BaseAnalyzer):
    def analyze(self, cluster_state: ClusterState) -> Dict[str, Any]:
        ...
        if not subjects_raw:
            # Schema registry probably isn't deployed for this cluster — nothing
            # to report. Topics analyzer already flags low coverage as info.
        ...
        if global_compat and global_compat.upper() not in _RECOMMENDED_COMPATIBILITY:
        ...
        if user_topic_count and unique_topics_with_schemas:
